...
type Snapshot struct {
	ClusterId        int64   `protobuf:"varint,1,req" json:"ClusterId"`
	Data             []byte  `protobuf:"bytes,2,opt" json:"Data,omitempty"`
	Nodes            []int64 `protobuf:"varint,3,rep" json:"Nodes,omitempty"`
	Index            int64   `protobuf:"varint,4,req" json:"Index"`
	Term             int64   `protobuf:"varint,5,req" json:"Term"`
...
func (m *Snapshot) Size() (n int) {
	var l int
	_ = l
	n += 1 + sovSnapshot(uint64(m.ClusterId))
	if m.Data != nil {
		l = len(m.Data)
...
func (m *Snapshot) MarshalTo(data []byte) (n int, err error) {
	...
	data[i] = 0x8
	i++
	i = encodeVarintSnapshot(data, i, uint64(m.ClusterId))
	if m.Data != nil {
		data[i] = 0x12
		i++
